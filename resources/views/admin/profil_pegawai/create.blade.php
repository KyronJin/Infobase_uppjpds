        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    <a href="{{ route('admin.profil_pegawai.index') }}" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-slate-200 text-[#063A76] rounded-xl hover:bg-slate-50 transition-colors" title="Kembali">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                    </a>
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-[#063A76]">Tambah Profil Pegawai Baru</h1>
                        <p class="text-sm text-slate-600 mt-1">Buatlah profil pegawai perpustakaan baru</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form id="formTambahPegawai" action="{{ route('admin.profil_pegawai.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="nama" 
                        value="{{ old('nama') }}"
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#063A76] focus:border-transparent @error('nama') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <select 
                        name="jabatan_id" 
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#063A76] focus:border-transparent @error('jabatan_id') border-red-500 @enderror"
                        required>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        id="deskripsi"
                        rows="6"
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#063A76] focus:border-transparent @error('deskripsi') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-slate-300 rounded-xl p-6 text-center hover:border-[#063A76] transition cursor-pointer" onclick="document.getElementById('foto-input').click()">
