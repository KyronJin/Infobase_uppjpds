      ...
      <div class="lg:col-span-1">
        <div class="sticky top-24">
          ...
          <div id="galleryCarousel" class="relative mb-8">
            ...
            @if(count($aboutPhotos) > 0)
              ...
              <div class="flex justify-center gap-2 mt-4">
                @for($i = 0; $i < count($aboutPhotos); $i++)
                  <button 
                    onclick="goToCarouselSlide({{ $i }})" 
                    class="carousel-dot w-2 h-2 rounded-full bg-gray-300 hover:bg-[#00425A] transition-all duration-300 {{ $i === 0 ? 'bg-[#00425A] w-3' : '' }}"
                    data-index="{{ $i }}"
                  ></button>
                @endfor
              </div>
          ...
          <div class="grid grid-cols-2 gap-8">
            <div class="bg-gradient-to-br from-[#00425A] to-[#003144] text-white p-6 rounded-xl aspect-[4/3] flex flex-col justify-center">
