...
<section class="py-16 bg-white">
  <div class="container mx-auto px-6">
    <div class="max-w-6xl mx-auto">
        ...
        <div>
          ...
          <div class="relative group cursor-pointer" onclick="openGalleryFromCarousel()">
            <div class="relative overflow-hidden rounded-lg h-64 shadow-md hover:shadow-lg transition-shadow" id="galleryCarousel">
              <img 
                id="carouselImage"
                src="<?php echo e(asset($aboutPhotos->first()->image_path)); ?>" 
                alt="Gallery" 
          ...
          <div class="mt-3 text-sm text-gray-600 text-center">
            Foto <span id="currentPhotoNum">1</span> dari <span id="totalPhotoNum"><?php echo e(count($aboutPhotos)); ?></span>
          </div>
          <?php endif; ?>
      ...
      <!-- Vision Section -->
      <div class="mb-16">
        <?php if($visiMisiContent): ?>
          <h2 class="text-4xl font-bold text-gray-900 mb-6"><?php echo e($visiMisiContent->title); ?></h2>
          <div class="bg-blue-50 border-l-4 border-[#00425A] p-8 rounded-lg prose prose-sm max-w-none">
            <?php echo $visiMisiContent->content; ?>
      ...
      <?php if($allAbouts && count($allAbouts) > 0): ?>
        <?php $__currentLoopData = $allAbouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if(!in_array($about->key, ['profil_institusi', 'visi_misi'])): ?>
            <div class="mb-16 p-8 bg-gradient-to-r from-slate-50 to-gray-50 rounded-lg border border-gray-200">
              <h2 class="text-3xl font-bold text-gray-900 mb-6"><?php echo e($about->title); ?></h2>
      ...
      <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div class="mt-8">
            <a href="<?php echo e(route('contact')); ?>" class="block w-full bg-[#F85E38] text-white font-semibold py-3 rounded-lg hover:bg-[#e84d28] transition-colors text-center">
...
<script>
  // Gallery data
  const galleryPhotos = <?php echo json_encode($aboutPhotos->map(function($photo) {
    return [
      'title' => $photo->title,
