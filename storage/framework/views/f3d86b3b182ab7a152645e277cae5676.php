    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex items-center gap-4 mb-4">
                <a href="<?php echo e(route('admin.pengumuman.index')); ?>" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-slate-200 text-[#063A76] rounded-xl hover:bg-slate-50 transition-colors shadow-sm" title="Kembali">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-8 lg:p-10">
            <form action="<?php echo e(route('admin.pengumuman.update', $pengumuman)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div>
                    ...
                    <input type="text" name="title" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#063A76] focus:border-[#063A76] transition-all" value="<?php echo e(old('title', $pengumuman->title)); ?>" placeholder="Masukkan judul pengumuman" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('published_at', $pengumuman->published_at?->format('Y-m-d\TH:i'))); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('unpublished_at', $pengumuman->unpublished_at?->format('Y-m-d\TH:i'))); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('valid_from', $pengumuman->valid_from?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('valid_until', $pengumuman->valid_until?->format('Y-m-d'))); ?>">
