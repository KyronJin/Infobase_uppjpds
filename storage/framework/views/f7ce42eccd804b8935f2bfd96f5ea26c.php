                ...
                <div class="mb-6 max-h-[50vh] overflow-y-auto">
                    <ul id="sortable" class="bg-gray-50 p-4 rounded-lg" style="list-style: none; margin: 0;">
                        <?php $__currentLoopData = $jabatans->sortBy('order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jabatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li data-id="<?php echo e($jabatan->id); ?>">
                                ...
                                <span class="font-medium text-gray-700 text-sm line-clamp-2"><?php echo e($jabatan->name); ?></span>
                                <button type="button" onclick="openDeleteJabatanModal('<?php echo e(addslashes($jabatan->name)); ?>', <?php echo e($jabatan->id); ?>)" class="px-2 py-1 w-full bg-red-50 text-red-600 text-xs font-semibold rounded hover:bg-red-100 transition-colors inline-flex items-center justify-center gap-1 mt-1">
