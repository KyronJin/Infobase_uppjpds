                ...
                <div class="relative group">
                                        ...
                                        <?php $__currentLoopData = $profilesInSlide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex flex-col items-center text-center space-y-3 flex-1 max-w-max">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <?php if($p->foto_path): ?>
                                                        <img src="<?php echo e(asset('storage/' . $p->foto_path)); ?>" alt="<?php echo e($p->nama); ?>" class="relative w-28 h-28 rounded-full object-cover border-4 border-white shadow-lg">
                                                    <?php else: ?>
                                                ...
                                                <!-- Nama -->
                                                <h3 class="text-base font-bold text-[#00425A] leading-tight min-h-10"><?php echo e($p->nama); ?></h3>
                                                <!-- Posisi/Jabatan -->
                                                <p class="text-sm text-[#f85e38] font-semibold leading-tight min-h-8"><?php echo e($p->jabatan ? $p->jabatan->name : 'Jabatan'); ?></p>
                                                <!-- Deskripsi -->
                                                <p class="text-gray-600 text-xs leading-relaxed line-clamp-4 min-h-16"><?php echo e($p->deskripsi ?? 'Berdedikasi untuk memberikan pelayanan terbaik bagi pengunjung perpustakaan.'); ?></p>
                                            </div>
                    ...
                    <div class="flex justify-center mt-8 space-x-3">
                        <?php for($i = 0; $i < $slides->count(); $i++): ?>
                            <button class="dot w-3 h-3 rounded-full bg-gray-300 hover:bg-[#00425A] transition-colors" data-slide="<?php echo e($i); ?>"></button>
                        <?php endfor; ?>
                    </div>
                </div>
            <?php else: ?>
