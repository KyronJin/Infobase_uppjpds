    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex items-center gap-3 mb-4">
                <a href="<?php echo e(route('admin.tata_tertib.index')); ?>" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-slate-200 text-[#063A76] rounded-xl hover:bg-slate-50 transition-colors" title="Kembali">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-8">
            ...
            <form action="<?php echo e(route('admin.tata_tertib.store')); ?>" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="jenis_tata_tertib_id" class="w-full px-4 py-3 border border-slate-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#063A76] focus:border-[#063A76] <?php $__errorArgs = ['jenis_tata_tertib_id'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="is_active" class="w-full px-4 py-3 border border-slate-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#063A76] focus:border-[#063A76] <?php $__errorArgs = ['is_active'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
