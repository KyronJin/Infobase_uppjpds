        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('admin.profile.index')); ?>" class="inline-flex items-center justify-center w-10 h-10 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors" title="Kembali">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <form action="<?php echo e(route('admin.profile.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="room_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['room_name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('room_name')); ?>" placeholder="Contoh: Ruang Baca Utama" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="floor" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" min="1" max="7" value="<?php echo e(old('floor')); ?>" placeholder="Lantai ke...">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Kapasitas</label>
                        <input type="number" name="capacity" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="<?php echo e(old('capacity')); ?>" placeholder="Jumlah orang">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" class="editor hidden" placeholder="Deskripsikan fasilitas dan keunggulan ruangan ini..."><?php echo e(old('description')); ?></textarea>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'lg','type' => 'submit','icon' => 'check']); ?>Buat Ruangan <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
