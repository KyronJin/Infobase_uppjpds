<header class="sticky top-0 z-50 bg-[#063A76] shadow-lg border-b-2 border-gray-200">
  <nav class="max-w-7xl mx-auto px-6 lg:px-12 py-2">
    <div class="flex items-center justify-between gap-4">
      <!-- Logo - Left -->
      <a href="<?php echo e(route('home')); ?>" class="brand-logo group flex-shrink-0">
        ...
        <div class="hidden sm:block">
          ...
          <p class="brand-logo-subtitle"><?php echo e(__('messages.library_name')); ?></p>
        </div>
      </a>
      ...
      <ul id="nav-links" class="hidden lg:flex items-center gap-8 flex-1 justify-center">
        <li>
          <a href="<?php echo e(route('home')); ?>" class="text-white font-medium hover:text-orange-300 transition duration-300 relative group/link whitespace-nowrap">
        ...
        <li>
          <a href="<?php echo e(route('about')); ?>" class="text-white font-medium hover:text-orange-300 transition duration-300 relative group/link whitespace-nowrap">
        ...
        <li class="relative">
          ...
          <div id="data-info-menu" class="absolute top-full left-0 mt-3 w-56 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 invisible transition-all duration-300 py-2 z-50">
            <a href="<?php echo e(route('infobase.pengumuman')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] transition duration-200 relative group/item">
              <i class="fas fa-bullhorn text-[#00425A] text-lg"></i>
              <div>
                <p class="font-semibold text-sm"><?php echo e(__('messages.announcements')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e(__('messages.view_announcements')); ?></p>
              </div>
            ...
            <a href="<?php echo e(route('infobase.calendar-aktifitas')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
              <i class="fas fa-calendar-alt text-[#f85e38] text-lg"></i>
              <div>
                <p class="font-semibold text-sm"><?php echo e(__('messages.calendar')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e(__('messages.view_activities')); ?></p>
              </div>
              <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
            </a>
            <a href="<?php echo e(route('infobase.profile-ruangan')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
              <i class="fas fa-door-open text-[#00425A] text-lg"></i>
              <div>
                <p class="font-semibold text-sm"><?php echo e(__('messages.room_profiles')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e(__('messages.view_room_facilities')); ?></p>
              </div>
              <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
            </a>
            <a href="<?php echo e(route('infobase.tata-tertib')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
              <i class="fas fa-book text-[#f85e38] text-lg"></i>
              <div>
                <p class="font-semibold text-sm"><?php echo e(__('messages.rules')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e(__('messages.view_regulations')); ?></p>
              </div>
              <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
            </a>
            <a href="<?php echo e(route('infobase.staff-of-month')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
              <i class="fas fa-star text-[#00425A] text-lg"></i>
              <div>
                <p class="font-semibold text-sm"><?php echo e(__('messages.staff_of_month')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e(__('messages.view_featured_staff')); ?></p>
              </div>
              <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
            </a>
            <a href="<?php echo e(route('infobase.profil-pegawai')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] transition duration-200 relative group/item">
              <i class="fas fa-users text-[#f85e38] text-lg"></i>
              <div>
                <p class="font-semibold text-sm"><?php echo e(__('messages.staff_profiles')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e(__('messages.view_staff_data')); ?></p>
              </div>
              <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
            </a>
          </div>
      ...
      <div class="hidden lg:flex items-center gap-3">
        ...
        <div class="relative">
          <button id="lang-btn" class="flex items-center gap-2 px-3 py-2 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition duration-300 whitespace-nowrap text-sm font-medium">
            ...
            <span id="lang-display"><?php echo e(strtoupper(app()->getLocale())); ?></span>
          ...
          <div id="lang-menu" class="absolute top-full right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible transition-all duration-300 py-2 z-40">
            <a href="<?php echo e(route('language.switch', 'id')); ?>" data-lang="id" class="w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 transition duration-200 text-sm font-medium">
              <i class="fas fa-check text-[#f85e38] <?php echo e(app()->getLocale() == 'id' ? '' : 'hidden'); ?>" id="check-id"></i>
              <span><?php echo e(__('messages.indonesian')); ?></span>
            </a>
            <a href="<?php echo e(route('language.switch', 'en')); ?>" data-lang="en" class="w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 transition duration-200 text-sm font-medium border-t border-gray-100">
              <i class="fas fa-check text-[#f85e38] <?php echo e(app()->getLocale() == 'en' ? '' : 'hidden'); ?>" id="check-en"></i>
        ...
        <?php if(auth()->guard()->check()): ?>
          <div class="relative">
            ...
            <div id="admin-menu" class="absolute top-full right-0 mt-3 w-56 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 invisible transition-all duration-300 py-2 z-50">
              ...
              <a href="<?php echo e(route('admin.pengumuman.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
                <i class="fas fa-bullhorn text-[#00425A] text-lg"></i>
                <div>
                  <p class="font-semibold text-sm"><?php echo e(__('messages.announcements')); ?></p>
                  <p class="text-xs text-gray-500"><?php echo e(__('messages.manage_announcements')); ?></p>
                </div>
                <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
              </a>
              <?php endif; ?>

              <?php if(Route::has('admin.calendar.index')): ?>
              <a href="<?php echo e(route('admin.calendar.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
                <i class="fas fa-calendar-alt text-[#f85e38] text-lg"></i>
                <div>
                  <p class="font-semibold text-sm"><?php echo e(__('messages.calendar')); ?></p>
                  <p class="text-xs text-gray-500"><?php echo e(__('messages.manage_calendar')); ?></p>
                </div>
                <span class="absolute left-0 top-1/2 w-1 h-0 bg-[#f85e38] group-hover/item:h-1/2 transition-all duration-300 -translate-y-1/2"></span>
              </a>
              <?php endif; ?>
              ...
              <a href="<?php echo e(route('admin.profile.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
                <i class="fas fa-door-open text-[#00425A] text-lg"></i>
                <div>
              ...
              <a href="<?php echo e(route('admin.tata_tertib.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
                <i class="fas fa-book text-[#f85e38] text-lg"></i>
                <div>
              ...
              <?php if(Route::has('admin.staff-of-month.index')): ?>
              <a href="<?php echo e(route('admin.staff-of-month.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
                <i class="fas fa-star text-[#00425A] text-lg"></i>
                <div>
              ...
              <a href="<?php echo e(route('admin.profil_pegawai.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
                <i class="fas fa-users text-[#f85e38] text-lg"></i>
                <div>
              ...
              <a href="<?php echo e(route('admin.gallery.index')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-50 hover:text-[#00425A] border-b border-gray-100 transition duration-200 relative group/item">
    ...
    <div id="mobile-menu" class="hidden lg:hidden mt-4 pb-4 border-t border-gray-200">
      ...
      <div class="flex items-center justify-between gap-2 px-4 py-3 mb-4 bg-gray-100 rounded-lg">
        <div class="flex items-center gap-2">
          ...
          <select id="mobile-lang-select" class="bg-transparent text-black text-sm font-medium outline-none cursor-pointer">
            <option value="id" class="bg-white text-black" <?php echo e(app()->getLocale() == 'id' ? 'selected' : ''); ?>>ID</option>
            <option value="en" class="bg-white text-black" <?php echo e(app()->getLocale() == 'en' ? 'selected' : ''); ?>>EN</option>
          </select>
        </div>
      </div>
      ...
      <ul class="space-y-2">
        <li>
          <a href="<?php echo e(route('home')); ?>" class="block px-4 py-3 text-black hover:bg-gray-100 rounded-lg transition duration-300 font-medium">
            <?php echo e(__('messages.home')); ?>

          </a>
        </li>
        <li>
          <a href="<?php echo e(route('about')); ?>" class="block px-4 py-3 text-black hover:bg-gray-100 rounded-lg transition duration-300 font-medium">
            <?php echo e(__('messages.about_us')); ?>
        ...
        <li class="border-t border-gray-200 pt-4 mt-4">
          ...
          <div id="mobile-data-info-menu" class="hidden mt-2 space-y-1 pl-4 bg-gray-50 rounded-xl overflow-hidden shadow-inner">
            <a href="<?php echo e(route('infobase.pengumuman')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
              <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
                <i class="fas fa-bullhorn"></i>
              </div>
              <span class="text-sm font-semibold"><?php echo e(__('messages.announcements')); ?></span>
            </a>
            <a href="<?php echo e(route('infobase.calendar-aktifitas')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#f85e38] transition duration-300 transform hover:translate-x-1">
              <div class="w-8 h-8 rounded-lg bg-[#f85e38]/10 flex items-center justify-center text-[#f85e38]">
                <i class="fas fa-calendar-alt"></i>
              </div>
              <span class="text-sm font-semibold"><?php echo e(__('messages.calendar')); ?></span>
            </a>
            <a href="<?php echo e(route('infobase.profile-ruangan')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
              <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
                <i class="fas fa-door-open"></i>
              </div>
              <span class="text-sm font-semibold"><?php echo e(__('messages.room_profiles')); ?></span>
            </a>
            <a href="<?php echo e(route('infobase.tata-tertib')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#f85e38] transition duration-300 transform hover:translate-x-1">
              <div class="w-8 h-8 rounded-lg bg-[#f85e38]/10 flex items-center justify-center text-[#f85e38]">
                <i class="fas fa-book"></i>
              </div>
              <span class="text-sm font-semibold"><?php echo e(__('messages.rules')); ?></span>
            </a>
            <a href="<?php echo e(route('infobase.staff-of-month')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
              <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
                <i class="fas fa-star"></i>
              </div>
              <span class="text-sm font-semibold"><?php echo e(__('messages.staff_of_month')); ?></span>
            </a>
            <a href="<?php echo e(route('infobase.profil-pegawai')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#f85e38] transition duration-300 transform hover:translate-x-1">
              <div class="w-8 h-8 rounded-lg bg-[#f85e38]/10 flex items-center justify-center text-[#f85e38]">
        ...
        <li class="border-t border-gray-200 pt-4 mt-4">
          <?php if(auth()->guard()->check()): ?>
            ...
            <div id="mobile-admin-menu" class="hidden mt-2 space-y-1 pl-4 bg-gray-50 rounded-xl overflow-hidden shadow-inner">
              <?php if(Route::has('admin.pengumuman.index')): ?>
              <a href="<?php echo e(route('admin.pengumuman.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
                  <i class="fas fa-bullhorn"></i>
                </div>
                <span class="text-sm font-semibold"><?php echo e(__('messages.announcements')); ?></span>
              ...
              <?php if(Route::has('admin.calendar.index')): ?>
              <a href="<?php echo e(route('admin.calendar.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#f85e38] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#f85e38]/10 flex items-center justify-center text-[#f85e38]">
                  <i class="fas fa-calendar-alt"></i>
                </div>
                <span class="text-sm font-semibold"><?php echo e(__('messages.calendar')); ?></span>
              ...
              <?php if(Route::has('admin.profile.index')): ?>
              <a href="<?php echo e(route('admin.profile.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
                  <i class="fas fa-door-open"></i>
                </div>
              ...
              <?php if(Route::has('admin.tata_tertib.index')): ?>
              <a href="<?php echo e(route('admin.tata_tertib.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#f85e38] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#f85e38]/10 flex items-center justify-center text-[#f85e38]">
                  <i class="fas fa-book"></i>
                </div>
              ...
              <?php if(Route::has('admin.staff-of-month.index')): ?>
              <a href="<?php echo e(route('admin.staff-of-month.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
                  <i class="fas fa-star"></i>
                </div>
              ...
              <?php if(Route::has('admin.profil_pegawai.index')): ?>
              <a href="<?php echo e(route('admin.profil_pegawai.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#f85e38] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#f85e38]/10 flex items-center justify-center text-[#f85e38]">
                  <i class="fas fa-users"></i>
                </div>
              ...
              <?php if(Route::has('admin.gallery.index')): ?>
              <a href="<?php echo e(route('admin.gallery.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-white hover:text-[#00425A] transition duration-300 transform hover:translate-x-1">
                <div class="w-8 h-8 rounded-lg bg-[#00425A]/10 flex items-center justify-center text-[#00425A]">
...
</script><?php /**PATH C:\Users\Pemustaka\Desktop\Infobase_uppjpds\resources\views/components/navbar.blade.php ENDPATH**/ ?>