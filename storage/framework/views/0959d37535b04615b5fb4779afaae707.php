...
<header class="<?php if(Route::currentRouteName() === 'home'): ?> fixed navbar-home <?php else: ?> sticky navbar-default <?php endif; ?> top-0 left-0 right-0 z-50 w-full">
  <nav class="w-full px-4 md:px-6 lg:px-8 py-4">
    <div class="flex items-center justify-between gap-6 lg:gap-8">
      ...
      <ul id="nav-links" class="hidden lg:flex items-center gap-12 flex-1 justify-center nav-links">
        <li>
          <a href="<?php echo e(route('home')); ?>" class="text-white font-semibold hover:text-orange-300 transition duration-300 relative group/link whitespace-nowrap text-base">
        ...
        <li>
          <a href="<?php echo e(route('about')); ?>" class="text-white font-semibold hover:text-orange-300 transition duration-300 relative group/link whitespace-nowrap text-base">
        ...
        <li class="relative">
          ...
          <div id="data-info-menu" class="absolute top-full left-0 mt-3 w-48 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 invisible transition-all duration-300 py-2 z-50" style="background-color: white !important;">
            <a href="<?php echo e(route('infobase.pengumuman')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 transition duration-200 text-sm font-medium">
              <?php echo e(__('messages.announcements')); ?>

            </a>
            <a href="<?php echo e(route('infobase.calendar-aktifitas')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 border-b border-gray-100 transition duration-200 text-sm font-medium">
              <?php echo e(__('messages.calendar')); ?>

            </a>
            <a href="<?php echo e(route('infobase.profile-ruangan')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 border-b border-gray-100 transition duration-200 text-sm font-medium">
              <?php echo e(__('messages.room_profiles')); ?>

            </a>
            <a href="<?php echo e(route('infobase.tata-tertib')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 border-b border-gray-100 transition duration-200 text-sm font-medium">
              <?php echo e(__('messages.rules')); ?>

            </a>
            <a href="<?php echo e(route('infobase.staff-of-month')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 border-b border-gray-100 transition duration-200 text-sm font-medium">
              <?php echo e(__('messages.staff_of_month')); ?>

            </a>
            <a href="<?php echo e(route('infobase.profil-pegawai')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 transition duration-200 text-sm font-medium">
        ...
        <?php if(auth()->guard()->check()): ?>
          <div class="relative">
            ...
            <div id="admin-menu" class="absolute top-full right-0 mt-3 w-48 bg-white border border-gray-200 rounded-xl shadow-lg opacity-0 invisible transition-all duration-300 py-2 z-50" style="background-color: white !important;">
              ...
              <a href="<?php echo e(route('admin.pengumuman.index')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 transition duration-200 text-sm font-medium">
                <?php echo e(__('messages.announcements')); ?>
              ...
              <a href="<?php echo e(route('admin.calendar.index')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 border-t border-gray-100 transition duration-200 text-sm font-medium">
                <?php echo e(__('messages.calendar')); ?>
              ...
              <a href="<?php echo e(route('admin.staff-of-month.index')); ?>" class="block px-5 py-3 text-gray-700 hover:text-[#f97316] hover:bg-gray-50 border-t border-gray-100 transition duration-200 text-sm font-medium">
                Staff of Month
              </a>
              <?php endif; ?>
    ...
    <div id="mobile-menu" class="hidden lg:hidden mt-4 pb-4 border-t border-gray-200">
      ...
      <ul class="space-y-2">
        <li>
          <a href="<?php echo e(route('home')); ?>" class="block px-4 py-3 text-gray-900 hover:bg-gray-100 rounded-lg transition duration-300 font-medium">
            <?php echo e(__('messages.home')); ?>

          </a>
        </li>
        <li>
          <a href="<?php echo e(route('about')); ?>" class="block px-4 py-3 text-gray-900 hover:bg-gray-100 rounded-lg transition duration-300 font-medium">
            <?php echo e(__('messages.about_us')); ?>
        ...
        <li class="border-t border-gray-200 pt-4 mt-4">
          <?php if(auth()->guard()->check()): ?>
            ...
            <div id="mobile-admin-menu" class="hidden mt-2 space-y-1 pl-4 bg-white rounded-xl overflow-hidden shadow-inner border border-gray-100" style="background-color: #ffffff !important;">
              <?php if(Route::has('admin.pengumuman.index')): ?>
              <a href="<?php echo e(route('admin.pengumuman.index')); ?>" class="block px-4 py-3 text-gray-700 hover:text-[#f85e38] hover:bg-white transition duration-300">
                <span class="text-sm font-semibold"><?php echo e(__('messages.announcements')); ?></span>
              </a>
              <?php endif; ?>

              <?php if(Route::has('admin.calendar.index')): ?>
              <a href="<?php echo e(route('admin.calendar.index')); ?>" class="block px-4 py-3 text-gray-700 hover:text-[#f85e38] hover:bg-white transition duration-300 border-t border-gray-200">
                <span class="text-sm font-semibold"><?php echo e(__('messages.calendar')); ?></span>
              </a>
              <?php endif; ?>
              ...
              <?php if(Route::has('admin.staff-of-month.index')): ?>
              <a href="<?php echo e(route('admin.staff-of-month.index')); ?>" class="block px-4 py-3 text-gray-700 hover:text-[#f85e38] hover:bg-white transition duration-300 border-t border-gray-200">
