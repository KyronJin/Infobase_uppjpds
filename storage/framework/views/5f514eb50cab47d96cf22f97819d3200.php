...
<div class="bg-[#f8fafc] min-h-screen py-6 sm:py-8">
    ...
    <div class="mb-6 sm:mb-8 flex justify-between items-start">
        ...
        <a href="<?php echo e(route('admin.gallery.index')); ?>" class="bg-white border border-slate-200 text-[#063A76] font-semibold py-3 px-6 rounded-xl hover:bg-slate-50 transition duration-300">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-8">
        <form action="<?php echo e(route('admin.gallery.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                >
                    ...
                    <option value="building" <?php echo e(old('category') === 'building' ? 'selected' : ''); ?>>Gedung</option>
                    <option value="interior" <?php echo e(old('category') === 'interior' ? 'selected' : ''); ?>>Interior</option>
                    <option value="collection" <?php echo e(old('category') === 'collection' ? 'selected' : ''); ?>>Koleksi</option>
                    <option value="service" <?php echo e(old('category') === 'service' ? 'selected' : ''); ?>>Layanan</option>
                    <option value="facility" <?php echo e(old('category') === 'facility' ? 'selected' : ''); ?>>Fasilitas</option>
                    <option value="activity" <?php echo e(old('category') === 'activity' ? 'selected' : ''); ?>>Aktivitas</option>
                </select>
            </div>
            ...
            <div>
                ...
                >
                    ...
                    <option value="home" <?php echo e(old('location') === 'home' ? 'selected' : ''); ?>>Halaman Beranda</option>
                    <option value="about" <?php echo e(old('location') === 'about' ? 'selected' : ''); ?>>Halaman Tentang</option>
                    <option value="hero" <?php echo e(old('location') === 'hero' ? 'selected' : ''); ?>>Hero Banner Beranda</option>
                    <option value="both" <?php echo e(old('location') === 'both' ? 'selected' : ''); ?>>Kedua Halaman</option>
                </select>
            </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'lg','type' => 'submit','icon' => 'save']); ?>Simpan Foto <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Pemustaka\Desktop\Infobase_uppjpds\resources\views/admin/gallery/create.blade.php ENDPATH**/ ?>