                ...
                <div class="room-card">
                    ...
                    <?php if($item->images->count() > 0): ?>
                        <div class="slider-wrapper">
                            <div class="slider" id="slider-<?php echo e($item->id); ?>">
                                <?php $__currentLoopData = $item->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input 
                                        type="radio" 
                                        id="img-<?php echo e($item->id); ?>-<?php echo e($index); ?>" 
                                        name="room-<?php echo e($item->id); ?>"
                                ...
                                <?php if($item->images->count() > 1): ?>
                                    <div class="slider-dots">
                                        <?php $__currentLoopData = $item->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="slider-dot" for="img-<?php echo e($item->id); ?>-<?php echo e($index); ?>"></label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>

                                    <button class="slider-arrow prev" onclick="slidePrev('<?php echo e($item->id); ?>')">
                                        <i class="fas fa-chevron-left"></i>
                                    </button>
                                    <button class="slider-arrow next" onclick="slideNext('<?php echo e($item->id); ?>')">
                                        <i class="fas fa-chevron-right"></i>
                                    </button>

                                    <div class="slider-counter">
                                        <span id="counter-<?php echo e($item->id); ?>">1</span> / <?php echo e($item->images->count()); ?>
                    ...
                    <!-- Compact Room Info -->
                    <div class="room-info">
                        <h2 class="room-title"><?php echo e($item->room_name); ?></h2>
                        
                        <div class="room-meta">
                            <?php if($item->floor): ?>
                                <span class="room-badge">
                                    <i class="fas fa-layer-group"></i>Lantai <?php echo e($item->floor); ?>

                                </span>
                            <?php endif; ?>
                            <?php if($item->capacity): ?>
                                <span class="room-badge">
                                    <i class="fas fa-users"></i><?php echo e($item->capacity); ?> Orang
                                </span>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php if($item->description): ?>
                            <div class="room-description">
                                <?php echo nl2br(e(Str::limit($item->description, 150))); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Pemustaka\Desktop\Infobase_uppjpds\resources\views/infobase/profile-ruangan.blade.php ENDPATH**/ ?>