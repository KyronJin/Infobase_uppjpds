...
<html lang="id" class="scroll-smooth">
  ...
  <body class="bg-white text-gray-900 antialiased font-primary <?php echo e(request()->is('admin*') && !request()->routeIs('admin.login') && !request()->routeIs('admin.login.post') ? 'admin-panel-mode' : ''); ?>">
    <?php
        ...
        <div class="lg:pl-72 min-h-screen bg-[#f8fafc]">
          <header class="sticky top-0 z-30 h-20 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
              <span class="hidden sm:inline text-sm text-slate-600 font-medium"><?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
              <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-slate-200 text-slate-700 text-sm hover:bg-slate-50">
...
<?php /**PATH C:\Users\mSiWoRd01\Desktop\Infobase_uppjpds\resources\views/layouts/app.blade.php ENDPATH**/ ?>